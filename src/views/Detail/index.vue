    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <!-- 小图列表  -->
          <!-- currentIndex.sync="currentIndex"即会传递数据也更新数据的事件 update：currentIndex -->
          <ImageList
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in goods.spuSaleAttrList" :key="saleAttr.id">
                <dt class="title">{{ saleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  class="active"
                  v-for="saleAttr in goods.spuSaleAttrValueList"
                  :key="saleAttr.id"
                >
